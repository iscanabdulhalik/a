const initialData = {
      ...
      items: [
        {
          ...
          name: "Patates Tava",
          description:
            "Özel baharatlarla harmanlanmış kalın kesim çıtır patates.",
          price: "200.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Elma Dilim",
          description:
            "Baharatlı ve dışı çıtır, içi yumuşacık elma dilim patates.",
          price: "220.00 ₺",
          image:
            "https://images.unsplash.com/photo-1590165482155-a5083fcbaeba?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "at3",
          name: "Soğan Halkası",
          description:
            "Özel sepette servis edilen, altın sarısı çıtır soğan halkaları.",
          price: "120.00 ₺",
          image:
        ...
        },
        {
          ...
          price: "350.00 ₺",
          image:
            "https://images.unsplash.com/photo-1601314115160-26fecd835e58?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "at6",
          name: "Sigara Böreği",
          description:
            "Taze peynirli, ince hamurdan sarılmış çıtır çıtır klasik lezzet.",
          price: "220.00 ₺",
          image:
            "https://plus.unsplash.com/premium_photo-1663852705824-388f615392d4?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "at7",
          name: "Çıtır Tavuk",
        ...
        },
        {
          ...
          name: "Combo Tabak",
          description:
            "Patates, soğan halkası, çıtır tavuk ve peynir çubuklarından oluşan karma tabak.",
          price: "360.00 ₺",
          image:
            "https://images.unsplash.com/photo-1600803907087-f56d462fd26b?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "at9",
          name: "Izgara Köfte",
          description:
            "Özenle hazırlanmış, tam kıvamında pişmiş ızgara kasap köfte.",
          price: "490.00 ₺",
          image:
      ...
      items: [
        {
          ...
          name: "Klasik Burger",
          description:
            "Özel burger köftesi, taze yeşillikler ve karamelize soğan.",
          price: "380.00 ₺",
          image:
      ...
      items: [
        {
          ...
          name: "Karışık Tost",
          description:
            "Sucuk ve kaşar peynirinin tost ekmeğiyle sıcak buluşması.",
          price: "300.00 ₺",
          image: "tost.jpg",
        },
        {
          ...
          price: "250.00 ₺",
          image:
            "https://images.unsplash.com/photo-1518042459039-b903061616c2?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "ts3",
          ...
          price: "300.00 ₺",
          image:
            "https://images.unsplash.com/photo-1525351326368-efbb5cb6814d?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "ts4",
      ...
      items: [
        {
          ...
          name: "Espresso",
          description:
            "Taze çekilmiş %100 Arabica çekirdeklerinden yoğun aroma.",
          price: "100.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Latte",
          description:
            "Espresso, buharla ısıtılmış ipeksi süt ve ince köpük dengesi.",
          price: "160.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Flat White",
          description:
            "İnce süt köpüğü ile kahve tadını ön plana çıkaran lezzet.",
          price: "170.00 ₺",
          image:
            "https://images.unsplash.com/photo-1582214695420-562a05fc8234?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "sk7",
          name: "Cortado",
          description:
            "Eşit oranda espresso ve sıcak sütün pürüzsüz birleşimi.",
          price: "170.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Mocha",
          description:
            "Çikolata şurubu, sıcak süt ve espressonun tatlı dengesi.",
          price: "180.00 ₺",
          image:
            "https://images.unsplash.com/photo-1572442388796-11668aa44c0b?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "sk9",
        ...
        },
        {
          ...
          price: "180.00 ₺",
          image:
            "https://images.unsplash.com/photo-1485600649718-4a6c8e3ccfe8?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "sk11",
          name: "Red Eye",
        ...
        },
        {
          ...
          name: "Filtre Kahve",
          description:
            "Yavaş demlenmiş, yumuşak ve pürüzsüz içimli taze kahve.",
          price: "140.00 ₺",
          image:
            "https://images.unsplash.com/photo-1497935586351-b67a49e012bf?auto=format&fit=crop&w=400&q=80",
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Kahve keyfini uzun tutmak isteyenlere özel duble fincan.",
          price: "120.00 ₺",
          image: "geleneksel-kahveler.jpg",
        },
        {
          ...
          name: "Menengiç",
          description:
            "Kafeinsiz, kendine has fıstık aromasıyla yöresel lezzet.",
          price: "120.00 ₺",
          image: "geleneksel-kahveler.jpg",
        },
        {
          ...
          name: "Dibek",
          description:
            "Özel tokmakla dövülmüş, yumuşak ve kıvamlı anadolu kahvesi.",
          price: "110.00 ₺",
          image: "geleneksel-kahveler.jpg",
        },
        {
        ...
        },
        {
          ...
          description:
            "Su yerine taze süt ile pişirilmiş yumuşak Türk kahvesi.",
          price: "120.00 ₺",
          image: "geleneksel-kahveler.jpg",
        },
        {
          ...
          description:
            "Hafif çilek aromasıyla tatlandırılmış farklı bir deneyim.",
          price: "130.00 ₺",
          image: "geleneksel-kahveler.jpg",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          price: "160.00 ₺",
          image:
            "https://images.unsplash.com/photo-1551509134-2e61df3f7f02?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "sdk3",
          name: "Ice Mocha",
          description:
            "Buzlu süt, çikolata ve espressonun serinleten tatlı formu.",
          price: "180.00 ₺",
          image:
        ...
        },
        {
          ...
          price: "170.00 ₺",
          image:
            "https://images.unsplash.com/photo-1576092762744-5cf12d1b8c0a?auto=format&fit=crop&w=400&q=80",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          name: "Çay",
          description:
            "İnce belli bardakta, tam demiyle tavşan kanı Türk çayı.",
          price: "35.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Fincan Çay",
          description:
            "Keyfi uzun sürenler için büyük fincanda taze demleme çay.",
          price: "50.00 ₺",
          image:
            "https://images.unsplash.com/photo-1558160074-4d7d8bdf4256?auto=format&fit=crop&w=400&q=80",
        },
        ...
        },
        {
          ...
          price: "150.00 ₺",
          image:
            "https://images.unsplash.com/photo-1606820251787-8f553dc791e8?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "si5",
          name: "Chai Tea Latte",
      ...
      items: [
        {
          ...
          name: "Milkshake",
          description:
            "Vanilya, Çilek veya Çikolatalı tam kıvamında serin lezzet.",
          price: "240.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Limonata",
          description:
            "Taze sıkım limonlardan elde edilmiş buz gibi ev yapımı limonata.",
          price: "150.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Frozen",
          description:
            "Taze meyve püreleriyle hazırlanan yoğun buzlu ferahlık.",
          price: "220.00 ₺",
          image:
            "https://images.unsplash.com/photo-1556881286-fc6915169721?auto=format&fit=crop&w=400&q=80",
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Ayran",
          description:
            "Geleneksel lezzetlerimizin yanında bol köpüklü yayık ayran.",
          price: "50.00 ₺",
          image:
            "https://images.unsplash.com/photo-1626082895617-2c6c06a86c67?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "ms6",
          name: "Su",
          ...
          price: "35.00 ₺",
          image:
            "https://images.unsplash.com/photo-1559839913-1140226315ee?auto=format&fit=crop&w=400&q=80",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          name: "Waffle",
          description:
            "Taze meyveler, eritilmiş çikolata ve fındık ile servis edilen çıtır waffle.",
          price: "280.00 ₺",
          image: "waffle.png",
        },
        {
        ...
        },
        {
          ...
          name: "Cup Tatlılar",
          description:
            "Farklı aromalarla hazırlanan, pratik ve lezzetli kupa tatlıları.",
          price: "200.00 ₺",
          image:
        ...
        },
        {
          ...
          name: "Dilim Pastalar",
          description:
            "Günlük taze hazırlanan, enfes kremalı ve meyveli pasta çeşitleri.",
          price: "220.00 ₺",
          image:
      ...
      items: [
        {
          ...
          name: "Hibiscus",
          description:
            "Kendine has rengi ve mayhoş tadıyla ferahlatıcı hibiskus.",
          price: "220.00 ₺",
          image:
            "https://images.unsplash.com/photo-1551024709-8f23befc6f87?auto=format&fit=crop&w=400&q=80",
        },
        ...
        },
        {
          ...
          name: "Cool Lime",
          description:
            "Taze nane ve misket limonu ile gelen maksimum ferahlık.",
          price: "220.00 ₺",
          image:
            "https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?auto=format&fit=crop&w=400&q=80",
        },
        ...
        },
        {
          ...
          price: "220.00 ₺",
          image:
            "https://images.unsplash.com/photo-1497250681960-ef046c08a56e?auto=format&fit=crop&w=400&q=80",
        },
        {
          id: "kt9",
  ...
  settings: {
    ...
    footerText:
      "Kıyı esintisiyle hazırlanan lezzetler. Her gün taze ve günlük.",
  },
};
